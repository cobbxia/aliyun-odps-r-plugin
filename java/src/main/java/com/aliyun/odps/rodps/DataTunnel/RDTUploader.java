...
public class RDTUploader extends DTProcess<UploadWorker,UploadSession>{
	...
	public void upload(String savePath) throws ROdpsException, IOException {
	  ...
	  try {
        ...
        uploadSession = tunnel.createUploadSession(context.getProject(),
	...
	@Override
	public UploadWorker createWorker(int threadId,
			Context<UploadSession> context, long startRecordNumber,
